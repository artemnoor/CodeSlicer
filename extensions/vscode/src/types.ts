...
export interface ReviewState{status:"idle"|"ready"|"error";riskLevel:string;riskConfidence:string;riskReasons:string[];impacts:ImpactItem[];potentialImpacts:ImpactItem[];chains:EvidenceChain[];tests:TestRecommendation[];warnings:string[];limitations:string[];localDiffNotice:string}
