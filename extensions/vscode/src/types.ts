...
export interface CockpitState{runtime:RuntimeState;project:ProjectState;review:ReviewState}
export const INITIAL_STATE:CockpitState={runtime:{status:"unchecked",version:"Not checked",diagnostic:"Run Refresh to validate a local CodeSlicer executable."},project:{graphStatus:"unknown",freshness:"Not checked",graphifyAvailable:false},review:{status:"idle",riskLevel:"—",riskConfidence:"—",riskReasons:[],impacts:[],chains:[],tests:[],warnings:[],limitations:[],localDiffNotice:"Analyzes a local Git diff only; GitHub metadata, comments, and checks are not read."}};
