...
export interface CockpitState{runtime:RuntimeState;project:ProjectState;analysis:AnalysisProgressState;integration:IntegrationState;reviewSource:ReviewSourceState;history:ReviewHistoryEntry[];review:ReviewState;demo:DemoState;server:LocalServerState;codeGraph:CodeGraphState;gitGraph:GitGraphState;graphify:GraphifyState}
export const INITIAL_STATE:CockpitState={runtime:{status:"unchecked",version:"Not checked",diagnostic:"Run Refresh to validate a local CodeSlicer executable."},project:{readiness:"unknown",gitStatus:"unknown",gitMessage:"Git has not been checked yet.",graphStatus:"unknown",freshness:"Not checked",graphifyAvailable:false},analysis:{status:"idle",percent:0,message:""},integration:{githubTokenConfigured:false},reviewSource:{mode:"current-changes"},history:[],review:{status:"idle",riskLevel:"—",riskConfidence:"—",riskReasons:[],limitations:[],impacts:[],potentialImpacts:[],potentialAvailable:0,rejectedRelations:[],potentialLimitations:[],chains:[],tests:[],warnings:[],localDiffNotice:"Analyzes a local Git diff only; GitHub metadata, comments, and checks are not read."},demo:{status:"idle"},server:{status:"idle",url:"http://127.0.0.1:8001/",message:"Server is not running."},codeGraph:{status:"idle",nodes:[],edges:[],totalNodes:0,totalEdges:0,message:"Build an analysis, then open the code graph."},gitGraph:{status:"idle",commits:[],branches:[],remotes:[],message:"Open Git cockpit when you need branches or remotes."},graphify:{status:"idle",message:"Graphify is optional and separate from CodeSlicer evidence."}};
